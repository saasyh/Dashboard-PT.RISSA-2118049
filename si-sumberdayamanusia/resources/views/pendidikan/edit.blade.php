...
@section('content_header') 
    <h1 class="m-0 text-dark"><b>Edit Data Pendidikan<b></h1>
@stop
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="input" name="tingkat_pendidikan" id="tingkat_pendidikan" value="{{$pendidikan->tingkat_pendidikan ?? old('tingkat_pendidikan')}}">
